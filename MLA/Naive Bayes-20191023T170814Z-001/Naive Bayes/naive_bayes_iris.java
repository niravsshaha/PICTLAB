...
public class naive_bayes {
	naive_bayes()
	{
		try
		{
			BufferedReader training=new BufferedReader(new FileReader("C:\\Users\\RAMANI\\Desktop\\CL-VII\\naive_bayes\\iris.arff"));
			BufferedReader testing=new BufferedReader(new FileReader("C:\\Users\\RAMANI\\Desktop\\CL-VII\\naive_bayes\\iris.arff"));
			...
			System.out.printf("Accuracy of model is %.3f\n",result_set.pctCorrect());
			System.out.printf("Error in model is %.3f\n",result_set.errorRate()*100);
